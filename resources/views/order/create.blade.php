@extends('layouts.app', ['activePage' => 'order.create', 'titlePage' => __('Create order')])
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-7">
                                        <div class="form-group{{ $errors->has('quantity') ? ' has-danger' : '' }}">
                                            <input class="form-control{{ $errors->has('quantity') ? ' is-invalid' : '' }}" name="quantity" type="number" min="1" max="5000" required="true" aria-required="true"/>
                                    ...
                                    <div class="col-sm-7">
                                        <div class="form-group{{ $errors->has('workers') ? ' has-danger' : '' }}">
                                            @foreach($workers as $worker)
                                                <div>
                                                    <input class="{{ $errors->has('workers') ? ' is-invalid' : '' }}" name="workers[]" value="{{$worker->id}}" type="checkbox"/><p style="display: inline">{{ $worker->name}}</p>
                                                </div>
                                            @endforeach
